...
import { AbilityAliases, CR, DiceBySize, EXPORT_ICON, EXPORT_SYMBOL, SAVE_SYMBOL } from "../data/constants";
...
export default class StatBlockRenderer extends MarkdownRenderChild {
	...
	private _buildName(
		...
		if (name) {
			...
			iconEl.onclick = () => this.plugin.exportAsPng(name, this.containerEl);
